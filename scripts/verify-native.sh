...
for fixture in magicdesk_guest_files_test magicdesk_process_signal_test magicdesk_pty_working_directory_test magicdesk_pty_lifecycle_test magicdesk_pty_peer_output_test magicdesk_pipe_shell_test magicdesk_virtual_mouse_test magicdesk_virtual_mouse_setup_test; do
    printf 'Compile: %s (%s)\n' "$fixture" "$compiler"
...
printf 'Native host fixtures verified (17 runs).\n'
