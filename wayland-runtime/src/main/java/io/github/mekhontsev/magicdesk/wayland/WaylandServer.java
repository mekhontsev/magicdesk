...
public final class WaylandServer extends IWaylandServer.Stub {
    ...
    private static final class Output {
        ...
        int width, height;
        Output(long id, long handle, int width, int height) {
            this.id = id; this.handle = handle; this.width = width; this.height = height;
        }
    }
    ...
    @Override public void openOutput(long id, long window, int width, int height) {
        command(() -> {
            ...
            Output output = new Output(id, pointer, width, height);
    ...
    @Override public void key(long id, int code, boolean down) { output(id, pointer -> nativeKey(pointer, code, down)); }
    @Override public void closeWindow(long window) { command(() -> nativeCloseWindow(handle, window)); }
    ...
    private static native void nativeKey(long output, int code, boolean down);
    private static native void nativeCloseWindow(long server, long window);
}