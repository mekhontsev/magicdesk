...
- [ ] `./gradlew verifyDevelopment` passes.
- [ ] Relevant device or UI behavior was tested, or is not affected.
- [ ] No IDE metadata, local configuration, credentials, or device reports are included.
