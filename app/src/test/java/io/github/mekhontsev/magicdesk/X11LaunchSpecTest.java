...
public final class X11LaunchSpecTest {
    @Test public void authorityIsStandardWildcardRecordWithRandomCookie() throws Exception {
        X11LaunchSpec spec = new X11LaunchSpec("/app.apk", "/lib", "org.example.host", "com.example.termux", "/termux/home", 96, false);
        ...
        assertNotEquals(spec.stdin, new X11LaunchSpec("/app.apk", "/lib", "org.example.host", "com.example.termux", "/termux/home", 96, false).stdin);
    }
    ...
    @Test public void rejectsInvalidDisplayAndEmptyCommands() {
        X11LaunchSpec spec = new X11LaunchSpec("/app.apk", "/lib", "org.example.host", "com.example.termux", "/home", 96, false);
