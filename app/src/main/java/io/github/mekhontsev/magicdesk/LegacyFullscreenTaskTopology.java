...
/**
 * Preserves the pre-planes fullscreen behavior behind the topology boundary.
 *
...
final class LegacyFullscreenTaskTopology implements ShellFullscreenTaskTopology {
    ...
    LegacyFullscreenTaskTopology(final ShellDesktopTaskOwnership ownership) {
        if (ownership == null) {
    ...
    public synchronized ShellFullscreenTaskArea.FocusResult focusStack(
        ...
        try {
            ...
            if (!isFullscreenStack(service, displayId, appTaskIds)) {
                final ShellFullscreenTaskArea.FocusResult mixedResult = focusMixedStack(
                        service, displayId, focusTaskIds);
                if (mixedResult != ShellFullscreenTaskArea.FocusResult.NOT_HANDLED) {
                    return mixedResult;
                }
    ...
    private ShellFullscreenTaskArea.FocusResult focusMixedStack(
            final Object service,
            final int displayId,
    ...
    private ShellFullscreenTaskArea.FocusResult applyFocus(
            final Object service,
            final int displayId,
    ...
    @Override
    public synchronized void onTaskMovedToFront(
            final int displayId,
            final int taskId) {
