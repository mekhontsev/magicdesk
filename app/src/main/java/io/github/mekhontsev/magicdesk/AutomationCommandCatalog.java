    ...
    static JSONArray create() throws JSONException {
        final JSONArray tools = new JSONArray()
                ...
                .put(actionTool("control_display", "Control display",
                        "Route phone-attached mice and keyboards to a display without starting Desktop. Use -1 to restore prior routes. Waits for routing readiness; OUTCOME_UNKNOWN does not cancel selection.",
