...
final class NubiaProjectionDriver implements PlatformProjectionDriver {
    ...
    public int waitForDesktopDisplay(final Context context) {
        return ConsoleDisplayController.waitForConsoleDisplay();
    }

    @Override
    public boolean waitForDesktopStop(final Context context) {
        return ConsoleDisplayController.waitForConsoleStop();
    }
    ...
    public boolean isMirrorMode() {
        return ConsoleDisplayController.isMirrorMode();
    }

    @Override
    public boolean requestDesktopMode(final int physicalDisplayId) {
        return ConsoleDisplayController.requestConsoleMode(physicalDisplayId);
    }

    @Override
    public boolean requestMirrorMode() {
        return ConsoleDisplayController.requestMirrorMode();
    }
