...
final class DesktopAutomationStateReader {
    ...
    JSONObject state() throws JSONException {
        ...
        final JSONObject result = new JSONObject()
                ...
                .put("limits", RuntimeLimits.toJson(mContext))
                ...
                .put("shell", new JSONObject()
                        .put("backend", shell.backend.name().toLowerCase(java.util.Locale.ROOT))
                        .put("configuredBackend", ShellBackend.configured(mContext).name().toLowerCase(java.util.Locale.ROOT))
                        .put("enabled", RuntimeLimits.active().privilegedAllowed())
                        .put("restartRequired", RuntimeLimits.restartRequired(mContext))
                        ...
                        .put("installed", RuntimeLimits.active().privilegedAllowed() ? shell.installed : JSONObject.NULL)
