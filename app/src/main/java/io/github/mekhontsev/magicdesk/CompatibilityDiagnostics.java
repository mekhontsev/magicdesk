...
public final class CompatibilityDiagnostics {
    ...
    static String buildReport(final Context context) {
        ...
        DesktopTaskConfigurationReport.append(report);
    ...
    private static void appendCompatibility(final StringBuilder report,
        ...
        report.append("## Runtime profile\n")
                ...
                .append('\n')
                .append("Runtime limits: active=").append(RuntimeLimits.active())
                .append(", configured=").append(RuntimeLimits.configured(context)).append('\n')
        ...
        report.append("MCP automation: enabled=")
                ...
                .append(", localPermissions=").append(mcp.localAccess.names())
                .append(", networkPermissions=").append(mcp.networkAccess.names())
                .append(", networkEnabled=").append(mcp.networkEnabled)
                .append(", networkRunning=").append(mcp.networkRunning)
                .append(", networkEndpoint=").append(mcp.networkEndpoint)
                .append(", networkError=").append(cleanSingleLine(mcp.networkError, 240))
