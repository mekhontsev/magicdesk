...
final class TermuxApplicationCommand {
    static String create() {
        ...
        return "set -e\ncount=0; total=0\n"
                ...
                + "  entry=$(LC_ALL=C awk '/^\\[/{section=($0==\"[Desktop Entry]\");next} section && /^(Type|Name|Icon|Exec|Path|Terminal|Hidden|NoDisplay|MimeType|StartupWMClass|X-MagicDesk-X11Mode|X-MagicDesk-X11FileEnvironment)=/{print}' \"$file\")\n"
