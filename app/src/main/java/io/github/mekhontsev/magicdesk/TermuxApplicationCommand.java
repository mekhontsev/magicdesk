...
final class TermuxApplicationCommand {
    static String create() {
        ...
        return "set -e\ncount=0; total=0\n"
                ...
                + "  entry=$(LC_ALL=C awk '/^\\[/{section=($0==\"[Desktop Entry]\");next} section && /^(Type|Name|Icon|Exec|Path|Terminal|Hidden|NoDisplay|MimeType|StartupWMClass|X-MagicDesk-Graphics|X-MagicDesk-KeyboardDirectory|X-MagicDesk-GraphicsMode|X-MagicDesk-FileEnvironment)=/{print}' \"$file\")\n"
